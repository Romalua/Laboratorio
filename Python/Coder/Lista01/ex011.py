...
print ("O produto do dobro de {:.0F} com metade de {:.0F} é {:.0F}".format(number1,number2, soluc1))
print ("A soma do triplo de {:.0F} com o valor de {:.0F} é {:.0F}".format(number1,number3, soluc2))
