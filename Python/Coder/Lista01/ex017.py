...
print('a quantidade de GALOES de 18 LITROS a ser usado é: {}'.format(
    math.ceil(qtd_latas18)))
print('a quantidade de LATAS de 3,6 LITROS a ser usado é: {}\n'.format(
    math.ceil(qtd_latas36)))
...
qtd_latas_mistas_total = math.trunc(
    qtd_latas_mistas18) + math.ceil(qtd_latas_mistas36)
...
print('quantidade de latas de 18 litros: {}'.format(
    math.trunc(qtd_latas_mistas18)))
